...
class Template
{
    const CLIENT_TEMPLATE_DIR = 'templates/standart/tpl/';
    const DOWN_TO_ROOT = '../../../';
    ...
    public function load_template($tpl_name)
    {
        ...
        if (($tpl_name != 'elements/title/title.tpl') && isset($_SESSION['dev_mode']) && ($_SESSION['dev_mode'] == 1)) {
            $this->template = "\n<!-- Start " . $tpl_name . " -->\n" . $this->template . "\n<!-- End " . $tpl_name . " -->\n";
        }
