...
{var:vertical_menu[5]['link']} support/ {/var}
    //Награды за посещения
{var:vertical_menu[6]['name']} Награды за посещения {/var}
{var:vertical_menu[6]['link']} activity_rewards {/var}
...
{var:vertical_menu_4[3]['link']} pages/baza_znaniy {/var}
    ...
    // ------------------------
    //banner 1
{var:footer_banners[0]['link']} https://kutsehariduskeskus.ee/ {/var}
{var:footer_banners[0]['img']} templates/standart/img/ivkhk.png{/var}
