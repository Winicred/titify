    ...
    <div class="item_data">
        ...
        <div class="item_footer">
            ...
            <div class="item_stats">
                <button class="likes {if('{is_liked}' == 'true')}active{/if}" onclick="add_favorite_track({id})" data-id="{id}" title="Click to like the track" data-bs-toggle="tooltip" data-bs-placement="bottom">
